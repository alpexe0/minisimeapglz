...
/* ============================================================
   ...
   ============================================================ */
const DEFAULT_HINT = 'Kalbime hedef alır mısın çok hızlı vurma ama :)) ♡';
const MISS_HINTS = ['Çok yaklaştın tekrar dene ♡', 'Kalbe vur aşkım ♡', 'Kaçırmayacağından eminim ♡'];
